...
public class DBN extends SQLiteOpenHelper {
    // declaring the required values
    private static final int DATABASE_VERSION = 2;
    private static final String DATABASE_NAME = "DBWoman";
    private static final String TABLE_NAME = "DBNotes";

    public DBN(Context context){
        super(context,DATABASE_NAME,null,DATABASE_VERSION);
    }

    // declaring the  table column names
    ...
    public int editNote(Note note){
        ...
        Log.d("Edited", "Title Edited: -> "+ note.getTitle() + "\n ID -> "+note.getId());
